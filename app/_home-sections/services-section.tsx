    ...
    <section id="services" className="bg-[#191919] px-6 py-20 sm:px-10 lg:px-16 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 font-raleway text-base text-[#a8a8a8] sm:text-lg">
          ...
          {SERVICES_DATA.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-raleway text-base font-bold text-white">{service.title}</h3>
                <p className="font-raleway text-sm leading-relaxed text-[#a8a8a8]">
                  {service.description}
                </p>
              </div>
            );
        ...
        <div className="mt-14 flex justify-center">
          <Link
            href="/services"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-[#569429] px-8 py-4 font-raleway text-sm font-bold uppercase tracking-wide text-black transition-all duration-300 hover:bg-[#63a92f] hover:shadow-[0_0_35px_-5px_#569429] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#569429] focus-visible:ring-offset-2 focus-visible:ring-offset-[#191919]"
          >
            Work With Us
