  ...
  return (
    <section className="relative flex flex-col items-center justify-center px-4 py-24 text-center md:py-32">
      ...
      <div className="relative z-10 flex max-w-3xl flex-col items-center gap-6">
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-green-500/10 border border-[#1DB954]/30 shadow-[0_0_30px_rgba(29,185,84,0.3)]">
          <Radio className="h-10 w-10 text-[#1DB954]" />
        </div>
        
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl text-white">
          DLSU Radio <span className="text-[#1DB954]">Green Giant FM</span>
        </h1>
